        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Page = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "page-1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnableRegistration = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    EnableCoursePurchase = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BunnyVideoId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseDiscounts", x => new { x.CourseId, x.DiscountId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "3", "00000000-0000-0000-0000-000000000003", "Instructor", "INSTRUCTOR" }
                });

            migrationBuilder.InsertData(
                table: "SystemSettings",
                columns: new[] { "Id", "Currency", "EnableCoursePurchase", "EnableEmailNotifications", "EnableRegistration", "SiteName", "SupportEmail", "SupportPhone", "UpdatedAt", "UpdatedBy", "WelcomeMessage" },
                values: new object[] { 1, "SAR", true, true, true, "منصتي التعليمية", "support@eduiplatform.com", "+966500000000", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "System", "مرحباً بكم في منصتنا التعليمية" });
